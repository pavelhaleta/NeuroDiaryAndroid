...
class TablePeriodData : SQLTable("PeriodData"){
    //table fields
    ...
    companion object{
        ...
        fun toList(db: SQLiteDatabase, whereClause: String): ArrayList<TablePeriodData>?{
            ...
            val list = ArrayList<TablePeriodData>()
            cursor.moveToFirst()
            for (i in 0 until cursor.count){
                val element = TablePeriodData()
