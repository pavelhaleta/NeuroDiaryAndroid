...
class TableContentParent : SQLTable("ContentParent"){
    //table fields
    ...
    companion object{
        ...
        fun toList(db: SQLiteDatabase, whereClause: String): ArrayList<TableContentParent>?{
            ...
            val list = ArrayList<TableContentParent>()
            cursor.moveToFirst()
            for (i in 0 until cursor.count){
                val element = TableContentParent()
